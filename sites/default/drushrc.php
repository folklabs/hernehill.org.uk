...
/**
 * Increases memory limit for running drush to allow features to be
 * recreated and not time-out
 * See: http://www.mcdruid.co.uk/content/
 * how-to-increase-php-memory-limit-for-drush-without-access-to-phpini
 */
